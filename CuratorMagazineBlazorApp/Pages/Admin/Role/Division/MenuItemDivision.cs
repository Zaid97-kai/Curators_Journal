...
namespace WebClient.Pages.Admin.Role.Division;
...
public partial class MenuItemDivision
{
    ...
    /// The divisions
    /// </summary>
    private List<Shared.Entities.Domains.Division>? _divisions;

    /// <summary>
    /// The selected rows
    /// </summary>
    private IEnumerable<Shared.Entities.Domains.Division>? _selectedRows;
    /// <summary>
    /// The table
    /// </summary>
    ...
    /// The edit cache
    /// </summary>
    private IDictionary<string, (bool edit, Shared.Entities.Domains.Division? data)> _editCache = new Dictionary<string, (bool edit, Shared.Entities.Domains.Division? data)>();
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        _divisions = JsonConvert.DeserializeObject<List<Shared.Entities.Domains.Division>>(ret.Result.Items?.ToString() ?? string.Empty);
    ...
    public async Task OnChange(QueryModel<Shared.Entities.Domains.Division> queryModel)
    {
